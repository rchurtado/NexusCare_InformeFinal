...
\section{Identity Vault: protección de datos personales}
...
\begin{itemize}
    \item Si el paciente no es elegible: \texttt{AUDITORIA\_COMPLETA} (omite LLM).
    \item Si el 70 \% o más de los ítems están excluidos: \texttt{RECHAZO\_ADMINISTRATIVO} (omite LLM).
    \item En cualquier otro caso: \texttt{TO\_LAYER2} (envía a Fase 2 para evaluación clínica).
\end{itemize}
