...
\section{Construcción del Golden Set}
...
\textbf{2 casos complejos pero consistentes} Liquidaciones con alto número de ítems donde la expectativa es \texttt{FAST\_TRACK} o \texttt{REVISION\_RAPIDA}. Estos casos prueban que el LLM no penaliza por volumen cuando la consistencia clínica es adecuada.
...
\section{Iteraciones de prompt engineering}
